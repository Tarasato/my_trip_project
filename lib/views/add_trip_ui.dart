...
class AddTripUI extends StatefulWidget {
  const AddTripUI({super.key});

  @override
  State<AddTripUI> createState() => _AddTripUIState();
}

class _AddTripUIState extends State<AddTripUI> {
  File? showImage;
  String? saveImage;
